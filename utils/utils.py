...
def draw_paint(im, kpts, mapNumber, epoch, model_arch, dataset):
    # print(kpts); raise Exception
    # [[171, 245], [164, 196], [188, 195], [188, 245], [188, 294], [179, 196], [179, 122], [179, 114], [180, 74], [155, 155], [138, 123], [163, 114], [196, 123], [204, 147], [204, 171]]
    ...
    # draw points
    for k in kpts:
        x = int(k[0] * im.shape[0])
        y = int(k[1] * im.shape[1])
        cv2.circle(im, (y, x), radius=3, thickness=-1, color=(0, 0, 255))
    ...
    cv2.imwrite('outputs/' + str(mapNumber).zfill(5) +'.png', im)
